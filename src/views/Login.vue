<template>
  <div id="login">
    ...
    <el-form-item v-if="isShow" prop="email">
        <el-input placeholder="Email" v-model="ruleForm.email" style="margin-bottom:10px">
            <template slot="append">.com</template>
        </el-input>
        <el-button style="padding:10px 20px;" :disabled="showBtn" type="primary" @click="sendMail">{{btntext}}</el-button>
    </el-form-item>
    <el-form-item>
        <el-input v-if="isShow" placeholder="请输入验证码" v-model="ruleForm.code">

        </el-input>
    </el-form-item>
    <el-form-item>
        <el-button style="padding:10px 20px;" type="primary" @click="submitForm('ruleForm')">登录</el-button>
        <el-button style="padding:10px 20px;" @click="register">我是新人</el-button>
    </el-form-item>
    <el-form-item>
        <p style="font-size:1rem;">提示: 没有账号可以点击我是新人进行注册,只需要验证邮箱就可以了,欢迎你的加入！</p>
    </el-form-item>
    </el-form>
  </div>
</template>
